...
// Define a type for SVG attributes
...
const LoadingVerify = () => {
  const svgAttributes: SVGAttributes = {
    ...
    y: '0px',
    viewBox: '0 0 100 100',
    // Disable JSX namespace check for the 'x' attribute
    // @ts-ignore
    style: { enableBackground: 'new 0 0 100 100' },
    xmlSpace: 'preserve',
  };
  const loaderSize = '100px';
  return (
    <Box height={loaderSize} width={loaderSize}>
      <Box
        position="absolute"
        height={loaderSize}
        width={loaderSize}
        sx={{
          ...
          svg: {
            ...
            fill: convertHex(colors.primary.purple[500], 0.5),
          },
        }}
      >
        <svg {...svgAttributes}>
