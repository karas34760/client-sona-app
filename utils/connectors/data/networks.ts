...
export const CHAINS: {
  ...
  324: {
    ...
    urls: [
      alchemyKey
        ? `https://polygonzkevm-mainnet.g.alchemy.com/v2/${alchemyKey}`
        : '',
  ...
  280: {
    ...
    urls: [
      alchemyKey
        ? `https://polygonzkevm-testnet.g.alchemy.com/v2/${alchemyKey}`
        : '',
  ...
  250: {
    ...
    urls: [
      infuraKey
        ? `https://fantom-mainnet.gateway.pokt.network/v1/lb/${pocketNetwork}`
        : '',
